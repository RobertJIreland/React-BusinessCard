...
const theme = createTheme({
  ...
  typography: {
    fontFamily: "'Raleway', 'Times New Roman', Times, serif",
  },
});
        ...
        <Grid container sx={{ margin: 0.5, marginLeft: 1 }}>
          ...
          <Grid item sx={{ padding: 0.5, paddingLeft: 0 }}>
            <p>
              ...
              Currently open for interviews, I'm most interested in front-end
              work but I have experience in Python and Django as well!
            </p>
          </Grid>
          <Grid item>
            <h3>Skills</h3>
